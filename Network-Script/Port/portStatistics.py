...
"""
This script was writen by https://github.com/DingGuodong/LinuxBashShellScriptForOps/blob/master/functions/net/tcp/port/portStatistics.py
i just copy from it.
...
port = 6305  # ssh -i /etc/ssh/ssh_host_rsa_key root@10.6.28.28
